...
class AltIMU(LSM6DS33):
    ...
    def update(self, deltaT = 0.02, indx=2):
        reading = self.getComplementaryAngles(deltaT = deltaT)
        self.balance_angle = reading[indx]-90 
        self.balance_gyro = self.gyrAngleY
        r=self.getAccelerometerAngles()
        self.balance_roll=r[0]
    ...
    def getAccelerometerAngles(self):
        ...
        # Calculate angle
        accelXAngle = math.degrees(math.atan2(accelYRaw, accelZRaw) )
